...
#[rustfmt::skip]
LoadDefinitions!({
  // Perl ar5iv-bindings/phyzzx.plus.ltxml — high-energy physics phyzzx
  // format addon. Source: http://arxiv.org/macros/phyzzx.plus. Perl port
  // is one 1013-line RawTeX block wrapping the raw phyzzx.plus file;
  // Rust mirrors that shape — straight RawTeX! with the identical body.
  RawTeX!(r#"
