...
pub const BINDINGS: &[(&str, &str, BindingLoader)] = &[
    ...
    ("aas_macros", "sty", package::aas_macros_sty::load_definitions),
    ...
    ("algcompatible", "sty", package::algcompatible_sty::load_definitions),
    ...
    ("revtex3_support", "sty", package::revtex3_support_sty::load_definitions),
    ...
    ("pstricks_support", "sty", package::pstricks_support_sty::load_definitions),
    ...
    ("tikz-3dplot", "sty", package::tikz_3dplot_sty::load_definitions),
    ...
    ("ifplatform", "sty", package::ifplatform_sty::load_definitions),
    ...
    ("emulateapj", "sty", package::emulateapj_sty::load_definitions),
    ("emulateapj5", "sty", package::emulateapj5_sty::load_definitions),
    ("cropmark", "sty", package::cropmark_sty::load_definitions),
    ("colordvi", "sty", package::colordvi_sty::load_definitions),
    ("circuitikz", "sty", package::circuitikz_sty::load_definitions),
    ("chapterbib", "sty", package::chapterbib_sty::load_definitions),
    ("braket", "sty", package::braket_sty::load_definitions),
    ("authblk", "sty", package::authblk_sty::load_definitions),
    ("attachfile", "sty", package::attachfile_sty::load_definitions),
    ...
    ("actuarialangle", "sty", package::actuarialangle_sty::load_definitions),
    ...
    ("bigintcalc", "sty", package::bigintcalc_sty::load_definitions),
    ...
    ("gettitlestring", "sty", package::gettitlestring_sty::load_definitions),
    ...
    ("kvdefinekeys", "sty", package::kvdefinekeys_sty::load_definitions),
    ...
    ("tablefootnote", "sty", package::tablefootnote_sty::load_definitions),
