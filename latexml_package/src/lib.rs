...
pub const BINDINGS: &[(&str, &str, BindingLoader)] = &[
  ...
  ("revtex4-2", "cls", package::revtex4_cls::load_definitions), // numeric APS default + author-year/numerical toggle (#6609)
  ...
  (
    "mathastext",
    "sty",
    package::mathastext_sty::load_definitions,
  ),
  ("mathenv", "sty", package::mathenv_sty::load_definitions),
  ...
  ("xpatch", "sty", package::xpatch_sty::load_definitions),
  ...
  (
    "USenglish",
    "ldf",
    package::babel_lang_stubs::load_usenglish,
  ),
  (
    "UKenglish",
    "ldf",
    package::babel_lang_stubs::load_ukenglish,
  ),
  ("canadian", "ldf", package::babel_lang_stubs::load_canadian),
  (
    "australian",
    "ldf",
    package::babel_lang_stubs::load_australian,
  ),
  (
    "newzealand",
    "ldf",
    package::babel_lang_stubs::load_newzealand,
  ),
  ("portuges", "ldf", package::babel_lang_stubs::load_portuges),
  (
    "portuguese",
    "ldf",
    package::babel_lang_stubs::load_portuguese,
  ),
  ("brazil", "ldf", package::babel_lang_stubs::load_brazil),
  (
    "brazilian",
    "ldf",
    package::babel_lang_stubs::load_brazilian,
  ),
  ...
  (
    "vietnamese",
    "ldf",
    package::babel_lang_stubs::load_vietnamese,
  ),
  (
    "icelandic",
    "ldf",
    package::babel_lang_stubs::load_icelandic,
  ),
  ...
  ("icml2019", "sty", package::icml2019_sty::load_definitions),
  (
    "icml2020",
    "sty",
    package::icml_support_sty::load_definitions,
  ...
  (
    "frontespizio",
    "sty",
    package::frontespizio_sty::load_definitions,
  ),
  ...
  ("causets", "sty", package::causets_sty::load_definitions),
  ...
  (
    "chemmacros",
    "sty",
    package::chemmacros_sty::load_definitions,
  ),
  ...
  (
    "translations",
    "sty",
    package::translations_sty::load_definitions,
  ),
  (
    "translator",
    "sty",
    package::translator_sty::load_definitions,
  ),
  ...
  (
    "libertinust1math",
    "sty",
    package::libertinust1math_sty::load_definitions,
  ),
  ...
  (
    "tikzlibrarytrees",
    "code.tex",
    package::tikzlibrarytrees_code_tex::load_definitions,
  ),
  (
    "pgfmathcalc",
    "code.tex",
  ...
  ("dirtytalk", "sty", package::dirtytalk_sty::load_definitions),
