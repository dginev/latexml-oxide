...
pub fn input_definitions(raw_file: &str, mut options: InputDefinitionOptions) -> Result<()> {
  ...
  if is_binding {
    ...
    let interpreting = lookup_bool_sym(&arena::INTERPRETING_DEFINITIONS_SYM);
...
pub fn input(request: &str, options: InputOptions) -> Result<()> {
  ...
  if lookup_bool_sym(&arena::INTERPRETING_DEFINITIONS_SYM) {
...
fn load_tex_definitions(request: &str, pathname: &str, reloadable: bool, at_letter: bool) -> Result<()> {
  ...
  let was_interpreting = lookup_bool_sym(&arena::INTERPRETING_DEFINITIONS_SYM);
  ...
  assign_value_sym(*arena::INTERPRETING_DEFINITIONS_SYM, true, None);
  ...
  assign_value_sym(*arena::INTERPRETING_DEFINITIONS_SYM, was_interpreting, None);
