...
% Comma-list of single-relop modifiers as function arguments
% (ASF migration item 5 / modified_term refinement, 2026-05-19).
% Previously ltx_math_unparsed; now parses as
% `P @ vector(x=0, y<0)` via the modified_term path.
$ P(x = 0, y < 0) $
