...
/// The no-dump path is guarded by
/// `cluster_package_guards::dump_gate_init::nodump_latex_branch_converts_healthily`,
/// which shares one raw kernel load across the NODUMP guards.
#[test]
