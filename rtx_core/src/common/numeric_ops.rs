...
pub trait NumericOps {
  fn new(num:i32) -> Self where Self: Sized;
  fn new_f32(num:f32) -> Self where Self: Sized;
  fn value_of(self) -> i32;
  fn value_f32(self) -> f32 where Self: Sized {
  ...
  fn add<T: NumericOps>(self, other: T) -> Self where Self: Sized {
