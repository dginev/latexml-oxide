...
LoadDefinitions!({
  ...
  // ltfilehook's `\CurrentFile` family is NOT defined here: latex.ltx:19582-19585
  // `\tl_new:N`s it, and a Base definition made every format build log "already
  // defined". The dump carries it; `latex.rs` covers NODUMP
