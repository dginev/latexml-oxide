...
| **R3** | **Bibliography-absence campaign** (PR #444) — **14 fixes landed**, **270 of the 533** known articles recovered / 18 829 entries, re-verified by reconversion. **263 still empty, all characterized** — plan R3a-R3g below. Corpus scope 50 777 | **R3a next** | per-item | [`BIB_ABSENCE_AUDIT_2026-07-29.md`](parity/BIB_ABSENCE_AUDIT_2026-07-29.md), [`RESIDUAL.md`](parity/bib_absence_2026-07-29/RESIDUAL.md) |
