...
| **R8** | **Generalized kernel-capability program** (branch `perfect_kernel`; user-approved 2026-09-05) — K1 definition provenance + overlay bindings, K3 lthooks store, K4 templates/sockets, K5 raw-line reader, K2 nest vs save stack (= R9), K6 font model, K7 file model, K8 runaway cap. **Continuation state 2026-09-20** (s107 270 invalid, ≈247 projected; next: s108 sweep → pgf memory lever → 77-doc frontmatter-ink ruling): [`PERFECT_KERNEL.md` → Continuation](PERFECT_KERNEL.md#continuation--state-and-next-steps-2026-09-20) | **OPEN**, batches through 56fd landed | program | [`perfect_kernel/KERNEL_CAPABILITIES.md`](perfect_kernel/KERNEL_CAPABILITIES.md) |
