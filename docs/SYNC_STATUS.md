...
- [ ] **H. expl3 full loading** — Session 49: implicit space fix (TeXbook p269) + l3file stub removal → l3keys NOW LOADS. All 36K lines process, l3skip/l3keys/l3intarray/l3fp/l3regex/l3text all available. expl3.lua.ltxml ported to Rust (native intarray ops). Remaining 13 benign errors: 5 undefined l3file forward-refs, 4 Unicode data file missing, 3 cctab messages, 1 endcsname. Session 48→49 errors: 1500→13.
