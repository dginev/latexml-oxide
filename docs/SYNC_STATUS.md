...
| April29 filesystem-level hard failures (missing or stub-sized .zip outputs) | **12 papers**: 8 share a `\lx@dual` recovery-digestion infinite-recursion cluster (1207.4607, cond-mat0203067, gr-qc9502017, 1702.02321, 1209.5192, 1302.3347, 1812.01755, 1707.05831), 2 OOM (math0005251, quant-ph0401134), 2 other (math0605199, 1506.09203). Cluster details in `memory/project_lx_dual_recovery_recursion.md`. |
