...
- [x] **35. graphrot_test** (65_graphics) — DONE (was 17, 239, 25, 127, 596). Session 26: sidewaystable full hooks (239→17), cmbx8/cmr8 metrics, parbox sizer. Updated XML for Rust dimension precision. 0 diffs.
...
- [ ] **34. mathtools_test** (56_ams) — 6683 diffs (was TIMEOUT). Now completes in ~5s after parser tree limit. Ported mathtools.sty. Remaining: many math parser structural diffs + missing DeclarePairedDelimiter family.
