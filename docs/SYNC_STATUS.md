...
| **R3** | **Bibliography-absence campaign** (PR #444) — **15 fixes landed**, **284 of the 533** known articles recovered / 19 790 entries, re-verified by reconversion. **249 still empty, all characterized** — plan R3a-R3g below. Corpus scope 50 777 | **R3a next** | per-item | [`BIB_ABSENCE_AUDIT_2026-07-29.md`](parity/BIB_ABSENCE_AUDIT_2026-07-29.md), [`RESIDUAL.md`](parity/bib_absence_2026-07-29/RESIDUAL.md) |
