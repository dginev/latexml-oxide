...
| R12 | in-progress (~77%) | ongoing | ~99.45% (instant) | 2 more session fixes: tikz-timing.sty no-op stub matching Perl missing-file behavior (`676be9cf53`, 8 papers); caption3 bootstrap chain `\caption@SetupOptions`/`\caption@ProcessOptions`/`\caption@IfPackageLoaded` (`85f8c87e96`, 4 of 5 papers cleaned) |
