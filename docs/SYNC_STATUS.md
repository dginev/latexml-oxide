...
| **R3** | **Bibliography-absence campaign** (PR #444) — **13 fixes landed**, **265 of the 533** known articles recovered / 18 613 entries, re-verified by reconversion. **268 still empty, all characterized** — plan R3a-R3g below. Corpus scope 50 777 | **R3a next** | per-item | [`BIB_ABSENCE_AUDIT_2026-07-29.md`](parity/BIB_ABSENCE_AUDIT_2026-07-29.md), [`RESIDUAL.md`](parity/bib_absence_2026-07-29/RESIDUAL.md) |
...
| **R3b** | **No diagnostic at all** — silent loss, complete document. **7 of 31 LANDED**: `\nocite{*}` now includes the whole library as bibtex does. Of the rest, **20 have real `\cite` calls** (chase these) and **4 cite nothing at all** (0 entries is correct there — exclude) | **20 left** | next |
