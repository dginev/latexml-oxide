...
**Status (2026-03-21):** 255 pass, 0 fail, 66 ignored (321 total). Session 17: get_arg(0)→panic. Diaghead, {rotatebox}, multirow. Grammar rules. colortbl backgroundcolor on td (RawTeX for @ tokenization, xcolor stub fix). eqnarray 222→123, sideset 481→336, colortbls 220→162.
