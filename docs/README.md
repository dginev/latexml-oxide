...
- **[`docs/parity/BIB_ABSENCE_AUDIT_2026-07-29.md`](docs/parity/BIB_ABSENCE_AUDIT_2026-07-29.md)** — (R3) Corpus-wide audit of documents lacking any `class="ltx_bibitem"`: method (fail-safe two-pass zip scan), headline counts (255+278 sandbox / 52 299 corpus wrongly-missing, 12 583 silent), cause families **F1–F12** with witnesses + minimal-repro pointers, and the **S1–S10 mini-sprint plan** mirrored in the R3 row. Complete per-corpus case lists + the sweep scripts live in [`docs/parity/bib_absence_2026-07-29/`](docs/parity/bib_absence_2026-07-29/) (README documents columns). Corpus zips predate the R5 re-port binary — see the binary-dating caveat before sizing engine families from corpus logs.
