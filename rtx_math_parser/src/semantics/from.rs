...
impl From<&str> for Operator {
  fn from(a: &str) -> Operator {
    Operator(Box::new(a.into()))
  }
}
impl From<String> for Operator {
  fn from(a: String) -> Operator {
    Operator(Box::new(a.as_str().into()))
  }
}
...
impl From<(&str, &str)> for Tree {
  fn from(a: (&str, &str)) -> Tree {
    Tree::Apply(a.0.into(), Args(vec![Some(a.1.into())]), Meta::default())
  }
}
impl From<(&str, (&str, &str))> for Tree {
  fn from(args: (&str, (&str, &str))) -> Tree {
    Tree::Apply(args.0.into(), args.1.into(), Meta::default())
  }
}

impl From<(&str, (&str, (&str, &str)))> for Tree {
  fn from(args: (&str, (&str, (&str, &str)))) -> Tree {
    Tree::Apply(
      args.0.into(),
...
impl From<(&str, (&str, (&str, [&str; 1])))> for Tree {
  fn from(args: (&str, (&str, (&str, [&str; 1])))) -> Tree {
    Tree::Apply(
      args.0.into(),
      Args(vec![Some(args.1.into())]),
      Meta::default(),
...
impl From<(&str, (&str, [&str; 1]))> for Tree {
  fn from(args: (&str, (&str, [&str; 1]))) -> Tree {
    Tree::Apply(
      args.0.into(),
      Args(vec![Some(args.1.into())]),
      Meta::default(),
